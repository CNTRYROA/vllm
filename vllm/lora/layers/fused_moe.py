...
class FusedMoEWithLoRA(BaseLayerWithLoRA):
    ...
    def _inject_lora_into_fused_moe(self):
            ...
            def wrapper(*args, **kwargs):
                ...
                def apply_decorator(func):
                    def wrapper(*args, **kwargs):
                        ...
                        expert_ids_lora = expert_ids_lora.view(
                            curr_topk_ids.shape[-1], -1
                        )
                        sorted_token_ids_lora = sorted_token_ids_lora.view(
                            curr_topk_ids.shape[-1], -1
                ...
                topk_weight_and_reduce.apply = apply_decorator(
                    topk_weight_and_reduce.apply
                )
        ...
        fused_experts.finalize_weight_and_reduce_impl = (
            finalize_weight_and_reduce_impl_decorator(
                base_layer, fused_experts.finalize_weight_and_reduce_impl
            )
        )
